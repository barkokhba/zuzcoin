Mac OS X zuzcoind build instructions
====================================
...
See `doc/readme-qt.rst` for instructions on building Zuzcoin-Qt, the
...
Much of this may be outdated for Zuzcoin.
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:zuzcoin-project/zuzcoin.git zuzcoin
        cd zuzcoin
...
For boost in zuzcoin, there are some ‘fun’ things you have to do:
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:zuzcoin/zuzcoin.git zuzcoin
        cd zuzcoin
...
It's now available at `./zuzcoind`, provided that you are still in the `src`
directory. We have to first create the RPC configuration file, though.

Run `./zuzcoind` to get the filename where it should be put, or just try these
commands:
...
Other commands:
    ...
    ./zuzcoind --help  # for a list of command-line options.
    ./zuzcoind -daemon # to start the zuzcoin daemon.
    ./zuzcoind help    # When the daemon is running, to get a list of RPC commands
