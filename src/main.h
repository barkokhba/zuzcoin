...
static const int64 MAX_MONEY = 100000000000 * COIN; // ZuzCoin: maximum of 200B coins (for now), max transaction 100,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // ZuzCoin: 1440 blocks found a day. Priority cutoff is 100 zuzcoin day / 250 bytes.
    }
