...
CNode* ConnectNode(CAddress addrConnect, const char *pszDest)
{
    ...
    /// debug print
    printf("trying connection %s : %u lastseen=%.1fhrs\n",
        pszDest ? pszDest : addrConnect.ToString().c_str(), GetDefaultPort(),
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zuzcoin " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zuzcoin is probably already running."), addrBind.ToString().c_str());
        else
